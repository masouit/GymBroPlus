...
public class Add_Exercise extends AppCompatActivity {
    ...
    public void addExercise(View view){
        ...
        long exercise_id = db.createExercise(exercise);
    ...
    public void addRepTextview(View view){
        if(repCount<100) {
            ...
            EditText editTextRep = (EditText) addView.findViewById(R.id.editTextRep);
        ...
        else{Toast.makeText(getApplicationContext(), "Cannot add more then 100 reps", Toast.LENGTH_SHORT).show();}
    }
